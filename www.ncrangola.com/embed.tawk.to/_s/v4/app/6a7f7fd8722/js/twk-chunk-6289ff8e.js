    ...
    ["chunk-6289ff8e", "chunk-2d0e4a7c"], {
        ...
        "499e": function(t, e, a) {
            ...
            function p(t) {
                for (var e = 0; e < t.length; e++) {
                    ...
                    if (i) {
                        ...
                        for (; s < a.parts.length; s++) i.parts.push(g(a.parts[s]));
                        i.parts.length > a.parts.length && (i.parts.length = a.parts.length)
                    } else {
                        var r = [];
                        for (s = 0; s < a.parts.length; s++) r.push(g(a.parts[s]));
                        n[a.id] = {
                            id: a.id,
                            refs: 1,
                            parts: r
            ...
            function g(t) {
                ...
                if (m) {
                    var s = c++;
                    i = o || (o = w()), e = v.bind(null, i, s, !1), a = v.bind(null, i, s, !0)
                } else i = w(), e = y.bind(null, i), a = function() {
                    i.parentNode.removeChild(i)
                };
                return e(t),
                    function(i) {
            ...
            var k = {
                    ...
                    methods: v(v({}, Object(i.b)({
                        ...
                        updateConversations: function() {
                            var t = w(this.historyConversations);
        ...
        d6a3: function(t, e, a) {
            ...
            var f = {
                ...
                b = function(t, e) {
                    ...
                    return t && (a && "/" === t.path && e || "chat" === t.path)
                };
            ...
            var S = {
                    ...
                    computed: k(k({}, Object(i.c)({
                        isWindowed: "widget/isWindowed",
                        isModernDirectChat: "widget/isModernDirectChat",
                        mobileBrowserName: "browserData/mobileBrowserName",
                        ...
                        borderRadiusBottom: function() {
                            if (!this.isModernDirectChat) return this.isWindowed || this.mobileBrowserName || this.isEmbedded ? "0px" : this.isRoundWidget ? "0 0 5px 5px" : "0px"
                        },
                        whitelabel: function() {
                            if (this.branding.whitelabeled) {
                                var t = w.a.markdownToHtml(this.branding.text);
                        ...
                        modernBrandingStyle: function() {
                            if (this.isModernDirectChat && !this.branding.whitelabeled) return {
                                position: "fixed",
                                left: "50%",
                                bottom: "0.75rem",
                                width: "fit-content",
                        ...
                        showChatInput: function() {
                            return b(this.currentView, this.hasChatStarted, this.isModernDirectChat && this.allowStartedHomeChatInput)
                        },
                        ...
                        isShowBranding: function() {
                            return !(!this.isModernDirectChat || this.branding.whitelabeled) || (this.branding.whitelabeled && this.mobileBrowserName || !this.isRoundWidget && this.branding.whitelabeled ? this.branding.text.length : !!this.isEmbedded || "max" !== this.onClick || this.mobileBrowserName || !this.isRoundWidget)
                        }
                    }),
                    methods: k(k({}, Object(i.b)({
                        routerPush: "router/routerPush",
                        showOverlay: "overlay/showOverlay",
                        clearHistory: "router/clearHistory"
                    })), {}, {
                        ...
                        chatFocus: function() {
                            this.$emit("chat-input-focus"), this.isModernDirectChat || (this.$refs["main-footer"].style.boxShadow = "0px -2px 8px rgba(0,0,0,.1)")
                        },
                        chatBlur: function() {
                            this.$emit("chat-input-blur"), this.isModernDirectChat || (this.$refs["main-footer"].style.boxShadow = "0 0 0 transparent")
                        },
                        paste: function(t) {
                        ...
                        clearChatInput: function() {
                            var t = this.$refs["tawk-chatinput"];
                            this.$TawkChatManager.clearTypingTimeout(), t && (t.$refs && t.$refs.chatinput && (t.$refs.chatinput.value = ""), t.hasValue = !1, t.files = [], t.showEmoji = !1, t.showRatings = !1)
                        },
                        autoFocusChatInput: function() {
                            var t;
                            null === (t = this.$refs["tawk-chatinput"]) || void 0 === t || null === (t = t.$refs) || void 0 === t || null === (t = t.chatinput) || void 0 === t || t.focus()
                        },
                    ...
                    watch: {
                        currentView: function(t) {
                            var e = this;
                            "chat" === t.path && this.$nextTick((function() {
                                e.autoFocusChatInput()
                            }))
                        },
                        chatWindowState: function(t) {
                            var e = this;
                            "max" === t && "chat" === this.currentView.path && setTimeout((function() {
                                e.autoFocusChatInput()
                            }), 500)
                        },
                ...
                O = Object(c.a)(S, (function() {
                    ...
                    return e("div", {
                        ...
                        style: t.modernBrandingStyle,
                        attrs: {
                            whitelabel: t.whitelabel,
                            imageUrl: t.imageUrl,
                            tawkToUrl: t.branding.url,
                            isFloating: t.isModernDirectChat && !t.branding.whitelabeled
                        }
            ...
            function $(t) {
                for (var e = 1; e < arguments.length; e++) {
                    ...
                    e % 2 ? T(Object(a), !0).forEach((function(e) {
                        P(t, e, a[e])
                    })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(a)) : T(Object(a)).forEach((function(e) {
                        Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(a, e))
                    }))
                }
                return t
            ...
            var j = {
                    ...
                    methods: {
                        convertToHTML: function(t) {
                            return w.a.markdownToHtml(t)
                        }
                    }
                },
                B = Object(c.a)(j, (function() {
                    var t = this,
                        e = t._self._c;
                    ...
                    methods: H(H({}, Object(i.b)({
                        ...
                        submitForm: function(t) {
                            ...
                            if (!t.hasError) {
                                ...
                                t.formData.submittedFrom = window.location.href, t.formData.customAttributes && (t.formData.widgetId = this.$store.getters["widget/id"]), this.$socket.publish("notifyOfflineMessage", t.formData, (function(a) {
            ...
            var G = {
                    ...
                    components: {
                        ...
                        HomeHeader: B,
                        HomeBody: F,
                        GeneralDataProtectionRegulation: function() {
                            return a.e("chunk-2d0c7ad3").then(a.bind(null, "5244"))
                        },
                        UsTwoParty: function() {
                            return a.e("chunk-2d2093a2").then(a.bind(null, "a7c9"))
                        }
                    },
                    props: {
                        isVisible: {
                    ...
                    computed: Z(Z({}, Object(i.c)({
                        states: "widget/states",
                        pageStatus: "session/pageStatus",
                        hasChatStarted: "chat/hasChatStarted",
                        prechatFormSubmitted: "session/prechatFormSubmitted",
                        needConsent: "session/needConsent",
                        consentFormType: "widget/consentFormType",
                        kbSelected: "knowledgeBase/selected"
                    })), {}, {
                        consentComponent: function() {
                            return this.needConsent ? this.consentFormType : null
                        }
                    }),
                    watch: {
                ...
                K = Object(c.a)(G, (function() {
                    ...
                    return e("base-frame", {
                        ...
                        ref: "tawk-home-body"
                    }, [t.consentComponent ? e(t.consentComponent, {
                        tag: "component"
                    }) : [e("home-header", {
            ...
            var at = {
                    name: "chat-header",
                    components: {
                        BaseHeader: Object(c.a)(X, (function(t, e) {
            ...
            var bt = {
                    ...
                    computed: wt({}, Object(i.c)({
                        states: "widget/states",
                        departments: "session/departments",
                        name: "visitor/name",
                        email: "visitor/getEmailValue",
                        pageStatus: "session/pageStatus",
                        isPrechatAiResponseSuppressed: "widget/isPrechatAiResponseSuppressed"
                    })),
                    watch: {
                        pageStatus: function(t) {
                    ...
                    methods: wt(wt({}, Object(i.b)({
                        ...
                        submitForm: function(t) {
                            var e = this;
                            t.hasError || (this.isSubmitting = !0, this.submissionError = !1, this.submissionSuccess = !1, this.$store.commit("session/setIsNotValidEmail", null), this.$store.commit("session/setIsNotValidPhone", null), t.formData.customAttributes && (t.formData.widgetId = this.$store.getters["widget/id"]), this.$socket.publish("notifyPrechat", t.formData, (function(a) {
                                var i = "";
                                ...
                                e.$store.commit("session/setPrechatSubmitted", !0), e.$TawkJSAPI.triggerApiHandlers("onPrechatSubmit", t.formData), e.$nextTick((function() {
                                    var a = [],
                                        s = t.formData,
                                        n = s.name,
                                        r = s.email,
                                        o = s.phone,
                                        c = s.department;
                                    if (n && a.push("Name : ".concat(n)), r && a.push("Email : ".concat(r)), o && a.push("Phone : ".concat(o)), c) {
                                        var l = e.departments.find((function(t) {
                                            return t.did === c
                                        }));
                                        a.push("Department : ".concat(l ? l.n : c))
                                    }
                                    for (var u = t.transcriptCustomFields || [], h = 0; h < u.length; h++) {
                                        var d = u[h],
                                            m = d.label,
                                            f = d.value,
                                            p = Array.isArray(f) ? f.join(", ") : f;
                                        a.push("".concat(m, " : ").concat(p))
                                    }(i = a.join("\r\n")) && e.$TawkChatManager.sendMessageToServer({
                                        message: i,
                                        isPreChat: e.isPrechatAiResponseSuppressed
            ...
            function Ot(t) {
                for (var e = 1; e < arguments.length; e++) {
                    ...
                    e % 2 ? St(Object(a), !0).forEach((function(e) {
                        xt(t, e, a[e])
                    })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(a)) : St(Object(a)).forEach((function(e) {
                        Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(a, e))
                    }))
                }
                return t
            ...
            var Tt = {
                    ...
                    components: {
                        ...
                        MaximizeFooter: O,
                        PrechatView: vt,
                        MessagesView: yt.default
                    },
                    mixins: [kt.a],
                    data: function() {
                        return {
                            cssLink: "".concat("https://embed.tawk.to/_s/v4/app/6a7f7fd8722", "/css/max-widget.css"),
                            classString: "",
                            showEndChat: !1,
                            noZoomMetaTag: null,
                            resizeHeightTo: null,
                            ...
                            isChatInputFocused: !1,
                            mobileVisualViewport: null,
                            isVisible: !1,
                            key: s.Helper.generateUUID(),
                            showConnected: !1,
                            allowStartedHomeChatInput: !1
                        }
                    },
                    computed: Ot(Ot({}, Object(i.c)({
                        ...
                        styleObject: function() {
                            ...
                            if (this.isWindowed || this.isEmbedded ? a["position:"] = "absolute !important;" : a["position:"] = "fixed !important;", this.isWindowed || this.mobileBrowserName || this.isEmbedded) {
                                var i = 0,
                                    ...
                                    n = 0,
                                    r = 0;
                                if (this.mobileBrowserName && e && e.mobile && e.mobile.maximized && (e.mobile.maximized.bottomOffset && (i = e.mobile.maximized.bottomOffset), e.mobile.maximized.topOffset && (r = e.mobile.maximized.topOffset), e.mobile.maximized.leftOffset && (n = e.mobile.maximized.leftOffset), e.mobile.maximized.rightOffset && (s = e.mobile.maximized.rightOffset), a["height:"] = "calc(100% - ".concat(i + r, "px) !important;"), a["min-height:"] = "calc(100% - ".concat(i + r, "px) !important;"), a["max-height:"] = "calc(100% - ".concat(i + r, "px) !important;"), a["width:"] = "calc(100% - ".concat(n + s, "px) !important;"), a["min-width:"] = "calc(100% - ".concat(n + s, "px) !important;"), a["max-width:"] = "calc(100% - ".concat(n + s, "px) !important;")), this.mobileVisualViewport) {
                                    var o = Math.max(this.mobileVisualViewport.height - r - i, 0);
                                    a["height:"] = "".concat(o, "px !important;"), a["min-height:"] = "".concat(o, "px !important;"), a["max-height:"] = "".concat(o, "px !important;"), r += this.mobileVisualViewport.offsetTop
                                }
                                a["bottom:"] = this.mobileVisualViewport ? "auto !important;" : "".concat(i, "px !important;"), a["right:"] = "".concat(s, "px !important;"), a["left:"] = "".concat(n, "px !important;"), a["top:"] = "".concat(r, "px !important;")
                            } else {
                                var c;
                                c = "slide" === this.onClick ? 0 : this.isCenter && this.isRoundWidget ? this.minDesktop.width + this.xOffset + 18 : this.xOffset, this.isRight ? a["right:"] = "".concat(c, "px !important;") : a["left:"] = "".concat(c, "px !important;"), this.isRoundWidget && "slide" !== this.onClick ? this.isBottom ? a["bottom:"] = "".concat(this.minDesktop.height + this.yOffset + 18, "px !important;") : (a["top:"] = "".concat(this.minDesktop.height + this.yOffset + 18, "px !important;"), a["bottom:"] = "auto !important;") : a["bottom:"] = "0px !important;"
                            }
                            return "max" === this.chatWindowState || this.isWindowed || this.isEmbedded ? a["display:"] = "block !important;" : a["display:"] = "none !important;", Ot(Ot({}, this.genericStyles), a)
                        },
                        ...
                        showChatInput: function() {
                            return b(this.currentView, this.hasChatStarted, this.allowStartedHomeChatInput)
                        },
                        hasModernDirectChatBranding: function() {
                            return this.isModernDirectChat && this.branding && !this.branding.whitelabeled
                        },
                        isModernDirectChatConversation: function() {
                            return this.isModernDirectChat && b(this.currentView, this.hasChatStarted, this.allowStartedHomeChatInput)
                        },
                        isModernDirectChatHome: function() {
                            return this.isModernDirectChat && "/" === this.currentRoute && !this.isModernDirectChatConversation
                        },
                        isModernDirectChatMessages: function() {
                            return this.isModernDirectChat && "messages" === this.currentRoute
                        },
                        isModernDirectChatEmpty: function() {
                            return this.isModernDirectChatConversation && 0 === this.chatOrder && !this.hasChatStarted
                        },
                    ...
                    watch: {
                        currentRoute: function(t) {
                            this.allowStartedHomeChatInput = g({
                                isVisible: this.allowStartedHomeChatInput,
                                isModernDirectChat: this.isModernDirectChat,
                                currentRoute: t,
                                hasChatStarted: this.hasChatStarted,
                                chatJustStarted: !1
                            })
                        },
                        hasChatStarted: function(t, e) {
                            this.allowStartedHomeChatInput = g({
                                isVisible: this.allowStartedHomeChatInput,
                                isModernDirectChat: this.isModernDirectChat,
                    ...
                    methods: Ot(Ot({}, Object(i.b)({
                        ...
                        openView: function() {
                            ...
                            if (!this.currentView && this.hasHomeView && this.routerPush("/"), "offline" !== this.pageStatus) {
                                if (!this.hasHomeView && !this.prechatFormSubmitted && this.isPrechatEnabled) return this.routerPush("prechat");
                                if ((this.hasChatStarted || 0 !== this.chatOrder) && this.hasLiveChat && (this.prechatFormSubmitted || !this.isPrechatEnabled)) return this.showOverlay(!1), this.routerPush("chat");
                                if (this.currentView && ("/" !== this.currentRoute || this.hasHomeView) || (this.hasLiveChat && this.hasChatStarted || !this.hasHomeView ? (this.routerPush("chat"), this.showOverlay(!1)) : this.showOverlay(!1)), 0 === this.getHistory.length) {
                                    if ("chat" === this.defaultView && !this.prechatFormSubmitted && this.isPrechatEnabled) return void this.routerPush("prechat");
                                    var s = "home" === this.defaultView ? "/" : this.defaultView;
                                    this.routerPush(s)
                                }
                            } else this.showOverlay(!1)
                        },
                        loaded: function() {
                            var t = this;
                        ...
                        handleChatInputFocus: function() {
                            this.isChatInputFocused = !0, this.updateMobileVisualViewport()
                        },
                        handleChatInputBlur: function() {
                            this.isChatInputFocused = !1, this.mobileVisualViewport = null
                        },
                        updateMobileVisualViewport: function() {
                            this.mobileVisualViewport = function(t) {
                                var e = t.mobileBrowserName,
                                    a = t.isWindowed,
                                    i = t.isEmbedded,
                                    s = t.isChatInputFocused,
                                    n = t.visualViewport;
                                return !e || a || i || !s || !n || "number" != typeof n.height || n.height <= 0 ? null : {
                                    height: n.height,
                                    offsetTop: Math.max(n.offsetTop || 0, 0)
                                }
                            }({
                                mobileBrowserName: this.mobileBrowserName,
                                isWindowed: this.isWindowed,
                                isEmbedded: this.isEmbedded,
                                isChatInputFocused: this.isChatInputFocused,
                    ...
                    mounted: function() {
                        var t = this;
                        this.calculateIframeSize(), this.noZoomMetaTag = document.createElement("meta"), this.noZoomMetaTag.name = "viewport", this.checkRouteLoaded(), this.$el.contentWindow.addEventListener("focus", this.handleFocus), this.$el.contentWindow.addEventListener("blur", this.handleBlur), window.addEventListener("resize", this.calculateIframeSize), window.visualViewport && (window.visualViewport.addEventListener("resize", this.updateMobileVisualViewport), window.visualViewport.addEventListener("scroll", this.updateMobileVisualViewport)), this.$eventBus.$on("switchWidget", (function() {
                    ...
                    beforeDestroy: function() {
                        this.$el.contentWindow.removeEventListener("focus", this.handleFocus), this.$el.contentWindow.removeEventListener("blur", this.handleBlur), window.removeEventListener("resize", this.calculateIframeSize), window.visualViewport && (window.visualViewport.removeEventListener("resize", this.updateMobileVisualViewport), window.visualViewport.removeEventListener("scroll", this.updateMobileVisualViewport))
                    }
                },
                $t = Object(c.a)(Tt, (function() {
                    var t = this,
                        e = t._self._c;
                    return e("i-frame", {
                        key: t.key,
                        ...
                        class: [!t.isToolbarElementsVisible && "tawk-no-toolbar-elements", t.isDirectChat && "tawk-direct-chat", t.isModernDirectChat && "tawk-direct-chat-modern", t.hasModernDirectChatBranding && "tawk-direct-chat-modern-branded", t.isModernDirectChatHome && "tawk-direct-chat-modern-home", t.isModernDirectChatMessages && "tawk-direct-chat-modern-messages", t.isModernDirectChatConversation && "tawk-direct-chat-modern-conversation", t.isModernDirectChatEmpty && "tawk-direct-chat-modern-empty"],
                        ...
                        staticClass: "tawk-max-content tawk-flex tawk-flex-column tawk-flex-1 tawk-custom-flex-1",
                        class: {
                            "tawk-kb-article-shell": "kb-article" === t.currentRoute, "tawk-history-chat-shell": "history-chat" === t.currentRoute
                        }
                    }, [e("div", {
                        ...
                        ref: "overlay-footer",
                        attrs: {
                            allowStartedHomeChatInput: t.allowStartedHomeChatInput
                        },
                        on: {
                            "chat-input-focus": t.handleChatInputFocus,
                            "chat-input-blur": t.handleChatInputBlur
                        }
                        ...
                        staticClass: "tawk-max-content tawk-flex tawk-flex-column tawk-flex-1"
                    }, [e("div", {
