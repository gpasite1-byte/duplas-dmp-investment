                    ...
                    if (null != o) {
                        ...
                        try {
                            if (a = (o = o.call(t)).next, 0 === e) {
                                ...
                                for (; !(l = (r = a.call(o)).done) && (s.push(r.value), s.length !== e); l = !0);
                        } catch (t) {
                            c = !0, n = t
                        } finally {
                            try {
            ...
            var l = r.a.component("i-frame", {
                    ...
                    render: function(t) {
                        return t("iframe", {
                            ...
                            attrs: {
                                srcdoc: this.isMaxWidget ? "<html></html>" : null,
                                src: this.isMaxWidget ? null : "about:blank",
                                frameborder: "0",
                                scrolling: "no",
                                width: this.width,
                                height: this.height,
                    ...
                    methods: {
                        renderChildren: function() {
                            var t = this.$slots.default,
                                ...
                                n = this.$el.contentDocument.head,
                            ...
                            s.href = this.cssLink, s.rel = "stylesheet", l.href = "https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700,700i,900,900i&subset=latin-ext", o.appendChild(i), o.classList.add("font-lato");
                            var d = "1rem",
                                h = "0";
                            if (this.$store.getters["widget/isRTL"] && o.classList.add("tawk-rtl"), this.$store.getters["browserData/mobileBrowserName"]) {
                                var m;
                                e.classList.add("tawk-mobile"), o.classList.add("tawk-mobile");
                                var g = null === (m = this.$TawkJSAPI) || void 0 === m || null === (m = m.local_API) || void 0 === m || null === (m = m.customStyle) || void 0 === m ? void 0 : m.visibility;
                            ...
                            this.$store.getters["widget/language"] && e.setAttribute("lang", this.$store.getters["widget/language"]);
                            ...
                            u.name = "viewport", u.content = "width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no", n.appendChild(p), n.appendChild(u);
                        ...
                        reInjectCSSGlobalVariables: function() {
                            ...
                            if (this.$store.getters["browserData/mobileBrowserName"]) {
                                var n, a = null === (n = this.$TawkJSAPI) || void 0 === n || null === (n = n.local_API) || void 0 === n || null === (n = n.customStyle) || void 0 === n ? void 0 : n.visibility;
                                a && a.mobile && a.mobile.maximized && (a.mobile.maximized.paddingTop && (o = "".concat(a.mobile.maximized.paddingTop, "px")), a.mobile.maximized.paddingBottom && (r = "".concat(a.mobile.maximized.paddingBottom, "px")))
                            }
                            var i = document.createElement("style");
                            i.type = "text/css", i.classList.add("tawk-global-variables");
                            var s = ":root {\n\t\t\t\t\t--tawk-header-background-color: ".concat(this.$store.getters["widget/headerBgColor"], " !important;\n\t\t\t\t\t--tawk-header-background-color-alpha: ").concat(this.$store.getters["widget/headerBgColor"], "50 !important;\n\t\t\t\t\t--tawk-header-text-color: ").concat(this.$store.getters["widget/headerTxtColor"], " !important;\n\t\t\t\t\t--tawk-header-override-padding-top: ").concat(o, " !important;\n\t\t\t\t\t--tawk-footer-override-padding-bottom: ").concat(r, " !important;\n\t\t\t\t}");
                            s += ".tawk-visitor-chat-bubble {\n\t\t\t\tbackground :  ".concat(this.$store.getters["widget/visitorBgColor"], " !important;\n\t\t\t\tcolor :  ").concat(this.$store.getters["widget/visitorTxtColor"], " !important;\n\t\t\t}"), s += ".tawk-visitor-chat-bubble .tawk-timeago {\n\t\t\t\tcolor :  ".concat(this.$store.getters["widget/visitorTxtColor"], " !important;\n\t\t\t}"), s += ".tawk-agent-chat-bubble {\n\t\t\t\tbackground :  ".concat(this.$store.getters["widget/agentBgColor"], " !important;\n\t\t\t\tcolor :  ").concat(this.$store.getters["widget/agentTxtColor"], " !important;\n\t\t\t}"), s += ".tawk-agent-chat-bubble .tawk-timeago {\n\t\t\t\tcolor :  ".concat(this.$store.getters["widget/agentTxtColor"], " !important;\n\t\t\t}"), s += ".tawk-agent-chat-bubble-dots {\n\t\t\t\tbackground :  ".concat(this.$store.getters["widget/agentBgColor"], " !important;\n\t\t\t}"), i.appendChild(document.createTextNode(s)), t.appendChild(i)
                        }
                    }
                }),
                c = o("2877"),
