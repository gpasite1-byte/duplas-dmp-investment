            ...
            var p = {
                ...
                h = Object(s.a)(p, (function() {
                    ...
                    return t("div", {
                        ...
                        return t("fieldset", {
                            key: n
                        }, ["text" === r.type || "custom" === r.type ? t("tawk-input", {
                            ref: r.id,
                            refInFor: !0,
            ...
            var _ = {
                    ...
                    methods: {
                        ...
                        parseMDToHTML: function(e) {
                            try {
                                var t, r = Object(g.a)(e, this.$TawkWindow.makeHtml, !0);
                                return (r instanceof Error || void 0 === r) && this.$TawkLogger.reportError({
                                    error: r,
                                    source: {
            ...
            var L = {
                    ...
                    computed: j(j({}, Object(n.c)({
                        ...
                        getSurveyOptions: function() {
                            for (var e = this, t = {}, r = null, n = 0, i = this.messageBlocks.length - 1; i >= 0 && null === r && n <= 3; i--) {
                                var a = this.messageBlocks[i];
                                if ("call" === a.messageType) break;
                                for (var s = a.messages.length - 1; s >= 0 && n <= 3; s--) {
                                    var o = a.messages[s];
                                    if (!o.data || !0 !== o.data.pcs) {
                                        r = o;
                                        break
                                    }
                                    n++
                            ...
                            return r && r.surveyObj && (t = j(j({}, r.surveyObj), {}, {
                ...
                a = {
                    methods: {
                        ...
                        setValue: function(e, t) {
                            t.value = e;
                            var r = t.value || "";
                            "string" == typeof e && (r = e.trim()), ("text" === t.type || "custom" === t.type || "number" === t.type || "date" === t.type || "textarea" === t.type) && t.isRequired && r.length > 0 && (t.invalidType = "")
                        },
                        ...
                        formatFields: function(e) {
                            for (var t = [], r = 0; r < e.length; r++) {
                                ...
                                if (i.required && (a.required = this.$i18n("form", "required_error_message")), i.context && "email" === i.context && (a.email = this.$i18n("form", "email_error_message"), s = this.email), i.context && "name" === i.context && (s = this.name), i.context && "phone" === i.context && (a.phone = this.$i18n("form", "invalid_length"), a.starts_with_zero = this.$i18n("form", "phone_error_message"), a.required = this.$i18n("form", "required_error_message"), a.invalid_length = this.$i18n("form", "incomplete_number"), a.invalid_country_code = this.$i18n("form", "phone_invalid_country_code")), "department" === i.context && this.departments.length) {
                                    ...
                                    var m = !["name", "email", "phone", "department"].includes(i.context);
                                    t.push({
                                        label: i.label,
                                        attributeMapping: (null == i ? void 0 : i.attributeMapping) || null,
                                        type: m ? i.type || "text" : i.context || i.type,
                                        isCustom: m,
                                        isRequired: i.required,
                        ...
                        formatFormData: function() {
                            var e = {},
                                t = !1,
                                r = [],
                                n = "prechat" === this.state;
                            e.customAttributes = {}, n || (e.questions = []);
                            for (var a = 0; a < this.formFields.length; a++) {
                                var s = this.formFields[a],
                                    o = s.value || "";
                                if ("string" == typeof o && (o = o.trim()), "name" === s.type) o.length > 0 && (e.name = o);
                                else if ("email" === s.type) o.length > 0 && (e.email = o);
                                else if ("phone" === s.type && o.length > 0) {
                                    var l = o.replace(/[\s\-()]/g, "");
                                    if (!this.isValidE164PhoneNumber(o) && l.length > 8) {
                                        s.invalidType = "phone", s.isError = !0, t = !0;
                                        continue
                                    }
                                    e.phone = "+".concat(l)
                                } else if ("department" === s.type) {
                                    if (s.isRequired && !this.selectedDepartment) {
                                        if (!s.selections || !s.selections.online.length && !s.selections.offline.length) continue;
                                        s.isError = !0, t = !0;
                                        continue
                                    }
                                    if (s.isError = !1, !this.selectedDepartment) continue;
                                    e.department = this.selectedDepartment.value, n || e.questions.push({
                                        label: i.a.rawDecode(s.label),
                                        answer: i.a.rawDecode(this.selectedDepartment.rawText)
                                    })
                                }
                                if (s.isRequired && 0 === o.length && "department" !== s.type && (this.$refs[s.id] && this.$refs[s.id].length && this.$refs[s.id][0] && this.$refs[s.id][0].validate && this.$refs[s.id][0].validate(), t = !0), s.isError) t = !0;
                                else if (o && o.length)
                                    if (s.isCustom) {
                                        var c = i.a.rawDecode(s.label);
                                        if (r.push({
                                                label: c,
                                                value: o
                                            }), s.attributeMapping && (e.customAttributes[s.attributeMapping] = o), !n) {
                                            var u = "string" == typeof o ? o : o.join(", ");
                                            e.questions.push({
                                                label: c,
                                                answer: u
                                            })
                                    ...
                                    var m = "string" == typeof o ? o : o.join(", ");
                                    e.questions.push({
                                        label: i.a.rawDecode(s.label),
                                        answer: m
                                    })
                            ...
                            return 0 === Object.keys(e.customAttributes).length && delete e.customAttributes, {
                                formData: e,
                                hasError: t,
                                transcriptCustomFields: r
                            }
                        },
